				...
				if(userSelection == JFileChooser.APPROVE_OPTION) {
					...
					if (arquivoSalvo.exists()) {
	                    int resposta = JOptionPane.showConfirmDialog(
	                            ...
	                            "O arquivo j� existe. Deseja sobrescrevê-lo?",
	                            "Arquivo existente",
					...
					try (PDDocument documento = new PDDocument()){
						...
						try (PDPageContentStream contentStream = new PDPageContentStream(documento, pagina)){
							...
							contentStream.newLineAtOffset(20, pagina.getMediaBox().getHeight() - 100);
 							...
 							contentStream.showText("ENDERE�O: Av. Prefeito Geraldo Pinho Alves, Nº 1.400, Maranguape I, Paulista/PE CEP: 53441-600");
 							contentStream.endText();
