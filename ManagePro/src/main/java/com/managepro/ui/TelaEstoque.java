...
public class TelaEstoque {
	...
	private void initialize() throws ParseException{
		...
		DefaultTableModel model = atualizarTudo();
		listaProduto = new JTable(model);
		...
		editarProduto.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    if (listaProduto.getSelectedRow() == -1) {
			    	JOptionPane.showMessageDialog(null, "Selecione o produto que deseja editar!", "Erro", JOptionPane.INFORMATION_MESSAGE);
			    }
			    else {
		...
		removerProduto.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (listaProduto.getSelectedRow() == -1) {
			    	JOptionPane.showMessageDialog(null, "Selecione o produto que deseja remover!", "Erro", JOptionPane.INFORMATION_MESSAGE);
			    }
				else {
