		...
		estoqueBotao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (Janela.getInstance().getTelaLogin().getFuncionarioLogado().getFuncao() == Cargos.ADMINISTRADOR 
					...
					JOptionPane.showMessageDialog(Janela.getInstance().getPanelPrincipal(), "Você não tem permissão para acessar o Estoque.");
				}
			}
		});
		...
		novaVendaBotao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (Janela.getInstance().getTelaLogin().getFuncionarioLogado().getFuncao() == Cargos.ADMINISTRADOR 
					...
					JOptionPane.showMessageDialog(Janela.getInstance().getPanelPrincipal(), "Você não tem permissão para criar uma nova Venda.");
				}
			}
		});
		...
		vendasBt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (Janela.getInstance().getTelaLogin().getFuncionarioLogado().getFuncao() == Cargos.ADMINISTRADOR 
					...
					JOptionPane.showMessageDialog(Janela.getInstance().getPanelPrincipal(), "Você não tem permissão para acessar o gerenciamento de vendas.");
				}
			}
		});
		...
		funcionariosBt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (Janela.getInstance().getTelaLogin().getFuncionarioLogado().getFuncao() == Cargos.ADMINISTRADOR 
					...
					JOptionPane.showMessageDialog(Janela.getInstance().getPanelPrincipal(), "Você não tem permissão para acessar o gerenciamento de funcion�rios.");
				}
			}
		});
		...
		contabilidadeBt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (Janela.getInstance().getTelaLogin().getFuncionarioLogado().getFuncao() == Cargos.ADMINISTRADOR 
					...
					JOptionPane.showMessageDialog(Janela.getInstance().getPanelPrincipal(), "Você não tem permissão para acessar a contabilidade.");
				}
			}
		});
