...
public class ProdutoService {
	...
	public void validacao(Produto produto) throws ValidacaoException {
		...
		// exce��es buscar produto
			...
			if (produto == null) {
				throw new ValidacaoException("Produto não existente.");
			}

			// exce��es gerais do produto

			if (produto.getNomeProduto() == null) {
			throw new ValidacaoException("Nome do produto é obrigatário");
			}
			...
			if (produto.getPreco() == null) {
				throw new ValidacaoException("Preço é obrigatário.");
			}
			...
			if (resultado < 0 || resultado == 0) {
				throw new ValidacaoException("Preço não pode ser negativo e/ou é obrigatário.");
			}
